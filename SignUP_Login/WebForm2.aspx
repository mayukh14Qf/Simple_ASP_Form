...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="sidebar">
            ...
            <asp:LinkButton ID="LinkButton1" runat="server" OnClick="sessison_back" >Log Out</asp:LinkButton>
        ...
        <div class="content">
            ...
            <div class="grid-container">
                ...
                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound" CssClass="grid" DataSourceID="SqlDataSource1" GridLines="None" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" DataKeyNames="Id">
